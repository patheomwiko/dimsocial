    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                <div class="top-left-part"><a class="logo" href="index.html"><b><img src="<?=base_url('assets/admin/images/logo-dim.png');?> alt="Dim" /></b><span class="hidden-xs"><img src="<?=base_url('assets/admin/images/logo-dim.png');?> alt=" CrowdFunding" /></span></a></div>
