...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            ...
            <div class="top-left-part"><a class="logo" href="index.html"><b><img src="<?=base_url('assets/admin/images/logo-dim');?>" alt="Dim" /></b><span class="hidden-xs"><img src="<?=base_url('assets/admin/images/logo');?>" alt=" CrowdFunding" /></span></a></div>                <ul class="nav navbar-top-links navbar-left m-l-20 hidden-xs">
                    <li>
