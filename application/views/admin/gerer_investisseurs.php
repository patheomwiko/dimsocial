...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            ...
            <div class="top-left-part"><a class="logo" href="index.html"><b><img src="<?=base_url('assets/admin/images/logo-dim.png');?>" alt="Dim" /></b><span class="hidden-xs"><img src="<?=base_url('assets/admin/images/logo-dim.png');?>" alt=" CrowdFunding" /></span></a></div>                <ul class="nav navbar-top-links navbar-left m-l-20 hidden-xs">
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gerer Les Investisseurs </h4> </div>
                    <!-- <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="http://wrappixel.com/templates/pixeladmin/" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro</a> -->
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                            <li class="active">Gerer Les Investisseurs</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Gerer Les Investisseurs</h3> </div>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
